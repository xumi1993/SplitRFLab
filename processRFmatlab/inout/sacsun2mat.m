function [SeisData, SAChdr,sacfiles]=sacsun2mat(varargin)
...
%    the fields as in the SAChdr structure generated by SAC's
%    matlab command MAT
%    
...
hdr.event.evla   = sacReadFloat(chrctr(141:141+F)); % EVent LAttitude
...
% no logical SAC header variables in matlab SAChdr structure!
...
lNumber = (256.^(3:-1:0))*cb;% Big endian
% lNumber = (256.^(0:1:3))*cb; % little endian
