...
for m=1:2
    ...
    tmp = ch(tmp,...
        ...
        'NZYEAR', eq(rf(i).eqidx).date(1),...
        'NZJDAY', eq(rf(i).eqidx).date(7),...
        'NZHOUR', eq(rf(i).eqidx).date(4),...
        'NZMIN',  eq(rf(i).eqidx).date(5),...
        'NZSEC',  floor(eq(rf(i).eqidx).date(6)),...
        'T1',     0,... 
        'KT1',    rf(i).phase,...
        'USER0',  Ev_para,...
        'KUSER0', 'Ray para',...
        ...
        'USER3',  f1,...
        'USER4',  f2,...
        'NZMSEC', round((eq(rf(i).eqidx).date(6) - floor(eq(rf(i).eqidx).date(6)))*1000));
