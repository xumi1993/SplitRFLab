...
uicontrol('Parent',h.panel(97),'Units','pixel',...
    ...
    'Callback','plotR_P(config.RFdatapath,config.plotrayp,config.h1,config.h2,config.k1,config.k2,config.searchh1,config.searchh2,config.searchk1,config.searchk2,config.averVp);');
