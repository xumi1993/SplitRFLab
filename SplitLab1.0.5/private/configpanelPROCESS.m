...
uicontrol('Parent',h.panel(98),'Units','pixel',...
    'Style','text',...
    'Position',[210 30 80 20],...
    'String', 'Time before P:',...
    'HorizontalAlignment','Left');

uicontrol('Parent',h.panel(98),'Units','pixel',...
    'Style','text',...
    'Position',[210 2 80 20],...
    'String', 'Time after P:',...
    'HorizontalAlignment','Left');
%% path edit
...
uicontrol('Parent',h.panel(97),'Units','pixel',...
    ...
    'String', 'Go stacking',...
    'Callback','hkmap(config.RFdatapath,config.hklstout,config.hkout,config.h1,config.h2,config.k1,config.k2,config.searchh1,config.searchh2,config.searchk1,config.searchk2,config.averVp);' );
uicontrol('Parent',h.panel(97),'Units','pixel',...
    'Style','Pushbutton',...
    'Position',[330 115 80 30],...
    'String', 'Plot R (by Rayp)',...
    'Callback','plotR_P(config.RFdatapath,config.averdir,config.plotrayp,config.h1,config.h2,config.k1,config.k2,config.searchh1,config.searchh2,config.searchk1,config.searchk2,config.averVp,config.sampling);');
