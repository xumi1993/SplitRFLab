...
uicontrol('Style','popupMenu','String',str,...
    ...
    'Value',val,...
    'BackgroundColor','w',...
    'Callback','tmp=get(gcbo,''string''); config.resamplingfreq = tmp{get(gcbo,''Value'')};if config.isoldver;SL_SeismoViewer4old(thiseq.index);else;SL_SeismoViewer(thiseq.index);end;');
