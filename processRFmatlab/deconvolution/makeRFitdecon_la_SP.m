function [RFI,RMS,it] = makeRFitdecon_la_SP(UIN,WIN,DT,NT,TSHIFT,F0,ITMAX,MINDERR)
...
% Phase shift
 P = phaseshift_SP(P,nfft,DT,TSHIFT);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function x = phaseshift_SP( x, nfft, DT, TSHIFT )
%
