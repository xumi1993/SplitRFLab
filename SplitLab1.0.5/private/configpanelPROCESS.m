...
axes( 'parent',h.panel(98), 'Units','pixel','position', [310 2 100 70])
image(icon.rf)
axis off
%% path edit
...
uicontrol('Parent',h.panel(98),'Units','pixel',...
    'Style','Pushbutton',...
    'Position',[155 15 120 30],...
    'ToolTipString','RE Calculate PRFs',...
...
axes( 'parent',h.panel(97), 'Units','pixel','position', [325 5 80 80])
image(icon.hk)
axis off
