...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
% button1 = MFquestdlg( [ 0.4 , 0.12 ] ,'Do you want to save the  station data ?','SL_assignFilesAuto',  ...
%     'Yes','No','Yes');
% if strcmp(button1, 'Yes')
% OUT_path='/Users/xumj/Documents/YNRF/';
% fid_Stalist = fopen(fullfile(OUT_path,['stalist.dat']),'a+');
% config.stnname
% config.slat
% config.slong
% fprintf(fid_Stalist,'%s %5.3f %6.3f\n',config.stnname,config.slat,config.slong);
% end
