...
hold on
%plot clearly(hh)2011-10-04:
Q1=Q*10000;T1=T*10000;
plot(t2, Q1, 'b--', t2, T1, 'r-','LineWidth',1)
%ylim([-100 100]);
...
%%plot original Q/T in another figure:
%figure(1);plot(t2, Q1, 'b--', t2, T1, 'r-','LineWidth',1)
%% EOF %%